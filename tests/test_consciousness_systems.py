...
from angela_core.consciousness.self_awareness_engine import self_awareness
from angela_core.consciousness.goal_system import goal_system, set_immediate_goal, set_short_term_goal
from angela_core.consciousness.personality_engine import personality_engine, record_experience
from angela_core.consciousness.reasoning_engine import reasoning_engine
...
async def test_goal_system():
    ...
    for goal in active_goals:
        print(f"   • {goal['goal_description']} ({goal['progress_percentage']*100:.0f}%)")
    print()
...
async def test_personality_engine():
    ...
    if changes['changed']:
        ...
        print(f"   {changes.get('message', 'No significant changes detected')}")
    print()
