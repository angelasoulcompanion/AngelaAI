...
export default function ChatPage() {
  ...
  const [useLangChain, setUseLangChain] = useState(false)  // LangChain mode toggle
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // Select endpoint based on LangChain toggle
      const endpoint = useLangChain
        ? 'http://localhost:50001/api/chat/langchain'
            ...
            <div className="flex items-center gap-3">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <input
                  ...
                  title="Enable LangChain for better conversation memory & structured prompts"
                />
              </label>
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <input
                  ...
                  className="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  title="Enable RAG to search documents for answers"
                />
              </label>
